...
directory = input('Directory path (example : C:/windows/desktop/my/project/) : '); path = path.join(directory, 'namedb'); mkdir(path); path = path.join(directory, 'package'); mkdir(path)
code = """
...
def convert(value: str):
  ...
  return value
"""
with open(f'{directory}/package/namedb.py') as f:
  f.write(code)
print('Setup is done !')