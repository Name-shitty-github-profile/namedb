...
directory = input('Directory path (example : C:/windows/desktop/my/project/) : '); path = path.join(directory, 'namedb'); mkdir(path); path = path.replace('namedb', 'package'); mkdir(path)
code = """
